# mkzinovyev-hw-03.md
zabbix 2
# Домашнее задание к занятию «Система мониторинга Zabbix. Часть 2» - `Зиновьев Михаил`
...
![Items in template](https://github.com/mkzinovev/mkzinovyev-hw-03.md/blob/main/screenshots/Задание_1_items.png)
...
#### Требования к результату
- [x] Прикрепите в файл README.md скриншот страницы хостов, где будут видны привязки шаблонов с названиями «Задание 2-3». Хосты должны иметь зелёный статус подключения
### Результаты выполнения заданий 2 и 3

 ![Задание 2 и 3](https://github.com/mkzinovev/mkzinovyev-hw-03.md/blob/main/screenshots/Задание_2-3_Host-templates.png)
...
Был создан пользовательский Dashboard, отображающий:
- текущие проблемы (Problems)
- доступность хостов (Host availability)
- график загрузки CPU
- график использования оперативной памяти в процентах.
...
#### Требования к результату
- [x] Прикрепите в файл README.md скриншот карты, где видно, что триггер сработал, с названием «Задание 5» 
...
На карту добавлены два хоста (zinovyevmk-1 и zinovyevmk-2) с автоматическим выбором иконок.

Между хостами был создан линк, отражающий логическую связность между ними.
...
При срабатывании триггера линк между хостами изменяет цвет и тип линии, что наглядно демонстрирует наличие проблемы.

Примечание

Для демонстрации работы link indicators был использован триггер файловой системы.
Триггеры доступности агента (Agent is unreachable) в Zabbix 6.4 относятся к системной логике доступности и не всегда используются для визуального изменения линков на карте, поэтому для корректной визуализации был выбран стандартный problem-триггер.
 ---
